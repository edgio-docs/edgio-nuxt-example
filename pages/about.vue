  ...
  <div class="flex min-h-[calc(100vh-56px)] flex-col items-center px-5 md:px-0">
    <div class="mt-10 flex w-full max-w-2xl flex-col p-2.5">
      ...
      <div class="mt-5 flex flex-row items-center space-x-3 text-lg text-[#FFFFFF90]">
        ...
        <a target="_blank" class="border-b border-[#FFFFFF75] text-sm md:text-lg" href="https://github.com/edgio-docs/edgio-nuxt-example">
          edgio-docs/edgio-nuxt-example
        </a>
      </div>
      <a class="mt-5" target="_blank" href="https://app.layer0.co/deploy?repo=https://github.com/edgio-docs/edgio-nuxt-example">
...
export default {
  data: () => {
    return {
      showcases: [
        `Edgio's Built-In Support for Nuxt(2)`,
